    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final _selectedPost = ItemData.fromStoreData(_posts[index]);
          final email = _selectedPost.user;
          bool isSold = _selectedPost.sell; // 판매 완료 여부
                                  ...
                                  return AlertDialog(
                                    ...
                                    actions: [
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          // 판매 완료 처리
                                          await _firestore.collection('crafty').doc(_posts[index].id).update({'sell': true});
                                          Get.back(); // 다이얼로그 닫기
                                        },
                                        child: Text('Confirm'),
                                      ),
                                  ...
                                  ClipRRect(
                                    ...
                                    child: _selectedPost.image != ''
                                        ? SizedBox(
                                            height: 100,
                                            width: 100,
                                            child: Image.network(_selectedPost.image, fit: BoxFit.cover),
                                          )
                                        : Container(),
                                  ),
                                ],
